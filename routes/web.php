...
Route::post('checkout/{course_slug}', 'CourseController@checkout_post')->name('course.checkout_post');
...
Route::get('jobs', 'HomeController@jobList')->name('jobs');
Route::get('job/{job_slug}', 'HomeController@jobView')->name('job.view');
...
Route::group(['middleware' => 'auth'], function () {
    ...
    Route::group(['middleware' => 'role:instructor'], function () {
        ...
        // Route::get('instructor-course-delete/{$course_id}', 'CourseController@deleteCourse');
        ...
        Route::get('instructor-course-quiz/{course_id}', 'CourseController@instructorQuizCurriculum')->name('instructor.quiz.curriculum');
        Route::post('instructor-course-curriculum-save', 'CourseController@instructorCourseCurriculumSave')->name('instructor.course.curriculum.save');
    ...
    Route::group(['middleware' => 'role:admin'], function () {
        ...
        Route::get('admin-course-list', 'CourseController@adminCourseList')->name('admin.course.list');
        ...
        Route::get('admin/job', 'Admin\JobController@index')->name('admin.jobs');
        Route::get('admin/job-form', 'Admin\JobController@getForm')->name('admin.jobForm');
        Route::get('admin/job-form/{job_id}', 'Admin\JobController@getForm');
        Route::post('admin/save-job', 'Admin\JobController@saveJob')->name('admin.savejob');
        Route::get('admin/delete-job/{job_id}', 'Admin\JobController@deleteJob');
