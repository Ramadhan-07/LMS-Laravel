...
<html>
    ...
    <nav class="navbar navbar-default fixed-top">
        <div class="row" style="flex-grow: 1;">
            <div class="col-6 col-sm-4 col-md-3 col-lg-2 col-xl-2" id="logo">
                ...
                <a href="{{ route('home') }}" class="float-xl-right"><img src="{{ asset('frontend/img/logo_magang.png') }}" width="120" height="30" /></a>
            </div>
    ...
    <div id="sidebar">
        <ul>
           ...
           @foreach ($categories as $category)
           <li>
                <a href="{{ route('course.list','category_id[]='.$category->id) }}">
                    <i class="fa {{ $category->icon_class }} category-menu-icon"></i>
                    {{ $category->name}}
                </a>
           </li>
    ...
    <footer id="main-footer">
        <div class="row m-0">
            ...
            <div class="col-lg-6 col-md-12 col-sm-12 text-center mt-4">
                <img src="{{ asset('frontend/img/logo_magang.png') }}" class="img-fluid" width="150" height="40">
                <br>
                <span id="c-copyright">
    ...
    <script type="text/javascript"
      ...
      data-client-key="SB-Mid-client-8NC11jUURZGJxi4H"></script>
