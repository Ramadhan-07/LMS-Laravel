        ...
        <div class="row mt-4">
            ...
            <div class="col-xl-9 col-lg-9 col-md-8">
                    ...
                    @if($course->overview)
                        ...
                        @if($course->meet_link)
                        <div>
                        <p>Join meeting on <a href="{{$course->meet_link}}">here!</a></p>
                         </div>
                         @endif
                    @endif
                    ...
                    @if($course->youtube_link)
                     ...
                     <iframe width="853" height="480" src="{{$course->youtube_link}}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe>
                    </div>
                    @endif
