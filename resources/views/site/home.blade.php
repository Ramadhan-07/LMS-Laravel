...
<!-- content start -->
    <div class="container-fluid p-0 home-content">
        ...
        <nav class="clearfix secondary-nav login-page-seperator">
               ...
               @foreach(${$tab_key.'_courses'} as $course)
                    <div class="col-xl-3 col-lg-4 col-md-6 col-sm-6">
                        ...
                        <div class="course-block mx-auto">
                            @if(Route::has('login'))
                            <a href="{{ route('course.learn', $course->course_slug) }}">
                            @else
                            <a href="{{ route('course.learn', $course->course_slug) }}">
                            @endif
                                <main>
                                    <!-- file asli -->
                                    <img src="{{ Storage::url($course->thumb_image) }}">
                                    ...
                                    <!-- file ke2 manual-->
                                    <!-- <img src="storage/course/2/thumb_businessman-with-light-bulb-his-hand_1232-892.jpg"> -->
                                    <!-- file ke-3 -->
                                    <!-- <img src="storage/course/{{$course->id}}/{{$course->thumb_image}}"> -->
            ...
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        ...
                        <p class="dblock-text" style="text-align:justify;">{!! Sitehelpers::get_option('pageHome', 'learn_block_text') !!}</p>
        ...
        <!-- dummy block start -->
        <article class="blog-learn" style="border-top: 2px solid rgba(216,216,216,0.5);">
            <div class="container">
                <div class="row">
                    <div class="col-xl-6 col-lg-6 col-md-6 vertical-align">
                        <img class="img-fluid mt-5 mx-auto" src="{{ asset('frontend/img/blog.png') }}"  width="400px" height="400px">
                    </div>
                    <div class="col-xl-6 col-lg-6 col-md-6">
                        <h3 class="dblock-heading">Jump into our blogs</h3>
                        <p class="dblock-text" style="text-align:justify;">{!! Sitehelpers::get_option('pageHome', 'learn_block_text') !!}</p>
                        <a href="{{ route('blogs') }}" class="btn btn-ulearn">View Blogs</a>
                    </div> 
                </div>
            </div>
        </article>
