      ...
      <div class="row">
        ...
        <div class="form-group col-md-4">
            ...
            <input type="text" class="form-control" name="course_title" 
                placeholder="Course Title" value="{{ $course->course_title }}" readonly/>
        ...
        <div class="form-group col-md-4">
            <label class="form-control-label">Meeting Link</label>
            <input type="text" class="form-control" name="meet_link" 
                placeholder="Meeting link" value="{{ $course->meet_link }}" />
        </div>

        <div class="form-group col-md-4">
            <label class="form-control-label">Youtube Link </label>
            <input type="text" class="form-control" name="youtube_link" 
                placeholder="Youtube Link" value="{{ $course->youtube_link }}" />
        </div>

        <div class="form-group col-md-4">
            <label class="form-control-label">Category </span></label>
        ...
        <div class="form-group col-md-4">
            ...
            <div>
              <div class="radio-custom radio-default radio-inline">
                <input type="radio" id="inputBasicActive" name="is_active" value="1" disabled @if($course->is_active) checked @endif />
                <label for="inputBasicActive">Active</label>
              </div>
              <div class="radio-custom radio-default radio-inline">
                <input type="radio" id="inputBasicInactive" name="is_active" value="0" disabled @if(!$course->is_active) checked @endif/>
